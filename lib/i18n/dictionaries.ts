...
export const dictionaries = {
  es: {
    ...
    projectsPage: {
      ...
      description:
        "Project Controls, ingeniería, experimentos con AI y las iniciativas donde también construyo negocios.",
      filters: {
        all: "Todos",
      ...
      buildingKicker: "Ahora mismo",
      buildingTitle: "Currently building",
      labKicker: "Engineering Lab",
      labTitle: "Experimentos y herramientas",
      labDescription:
        "Problemas reales de Project Controls, resueltos con código, datos y AI. Algunos son ideas tempranas; otros ya están en uso.",
      venturesKicker: "Ventures",
      venturesTitle: "Ventures",
      venturesDescription:
        "La ingeniería no se queda en mi trabajo del día a día. También construyo y opero iniciativas donde ingeniería, construcción, tecnología y negocio se encuentran.",
      exploreVenture: "Explorar",
  ...
  en: {
    ...
    projectsPage: {
      ...
      description:
        "Project Controls, engineering, AI experiments, and the ventures where I also build businesses.",
      filters: {
        all: "All",
        "project-controls": "Project Controls",
        planning: "Planning",
      ...
      buildingKicker: "Right now",
      buildingTitle: "Currently building",
      labKicker: "Engineering Lab",
      labTitle: "Experiments & tools",
      labDescription:
        "Real Project Controls problems, worked on with code, data and AI. Some are early ideas; others are already in use.",
      venturesKicker: "Ventures",
      venturesTitle: "Ventures",
      venturesDescription:
        "Engineering doesn't stop at my day-to-day work. I also build and operate ventures where engineering, construction, technology and business meet.",
      exploreVenture: "Explore",
